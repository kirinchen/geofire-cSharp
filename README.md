# GeoFire for C#/Unity — Realtime location queries with Firebase

GeoFire is an open-source library for Android/C# that allows you to store and query a
...
bar, e.g. name, business hours and price range, at `/tree/master/Example`. Later, you
...
## Including GeoFire in your project Android/C#
...
page](https://github.com/firebase/geofire-C#/releases).
...
[full API reference available online](https://geofire-C#.firebaseapp.com/docs/).
...
[A full API reference is available here](https://geofire-C#.firebaseapp.com/docs/).


## Contributing

If you want to contribute to GeoFire for C#, clone the repository
